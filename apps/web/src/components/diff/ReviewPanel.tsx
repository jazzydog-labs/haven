...
const ReviewPanel: React.FC<ReviewPanelProps> = ({
  ...
  return (
    <div className="review-panel bg-white border border-gray-200 rounded-lg p-4 min-w-80">
      {/* Current Status */}
      <div className="mb-4">
        <h3 className="text-sm font-medium text-gray-900 mb-2">Review Status</h3>
        {currentOption && (
          <div className={`flex items-center px-3 py-2 rounded-md border ${currentOption.color}`}>
          ...
          {statusOptions.map((option) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center px-3 py-2 rounded-md border text-sm font-medium transition-colors ${option.color} ${
