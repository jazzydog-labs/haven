...
class TestRepositoryIntegration:
    ...
    @pytest.mark.asyncio
    async def test_delete_record(self, test_session: AsyncSession, sample_record: Record) -> None:
    ...
    @pytest.mark.asyncio
    async def test_exists_check(self, test_session: AsyncSession, sample_record: Record) -> None:
