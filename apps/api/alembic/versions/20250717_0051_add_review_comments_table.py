...
down_revision: Union[str, None] = '20250716_2040'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_review_comments_commit_id'), 'review_comments', ['commit_id'], unique=False)
    ...
    op.create_index(op.f('ix_review_comments_line_number'), 'review_comments', ['line_number'], unique=False)
